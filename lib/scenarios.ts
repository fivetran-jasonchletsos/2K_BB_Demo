...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    category: "last-shot",
    difficulty: 2,
    title: "Down 2, 7 seconds, sideline OB",
    situation: [
      "Q4 · 0:07 left · Down 2",
      "Sideline OB at half court · 1 TO",
    ],
    myTeam: ["Butler (you)", "Herro", "Rozier", "Adebayo", "Ware"],
    theirTeam: ["Brunson", "DiVincenzo", "OG", "Hart", "Robinson"],
    context: "Robinson is the rim deterrent. Brunson is in 5-foul trouble guarding Butler. Bam is a 78% mid-range shooter on pop.",
    question: "Best read?",
    options: [
      { label: "DHO Butler → drive at Brunson", sub: "Foul-hunt the 6th", ev: 1.16, isOptimal: true },
      { label: "Pin-down Herro for 3", sub: "Catch-and-shoot wing", ev: 1.08, isOptimal: false },
      { label: "Iso Butler step-back 2", sub: "Tie game over Brunson", ev: 1.02, isOptimal: false },
      { label: "Lob to Adebayo at rim", sub: "Beat Robinson contest", ev: 0.78, isOptimal: false },
    ],
    coachingNote:
      "Brunson at 5 fouls is the read — Butler attacks downhill and either gets to the line (Butler shoots 86% FT) or kicks to a wider gap. The DHO forces Brunson to navigate the screen or switch, both bad outcomes for NY. Herro's pin-down 3 is fine (~36%) but lower EV than putting the worst defender in a 6th-foul corner. Don't lob into Robinson with the game tied — he averages 2.1 blocks/36.",
    references: [{ kind: "player", name: "Jimmy Butler" }],
  },
  {
    id: "last-shot-6",
    category: "last-shot",
    difficulty: 3,
    title: "Tied, 5.5 seconds, transition advance",
    situation: [
      "Q4 · 0:05.5 left · Tied",
      "Defensive rebound, you advance with TO · 1 TO left",
    ],
    myTeam: ["Lillard (you)", "Beasley", "Middleton", "Giannis", "Lopez"],
    theirTeam: ["LaVine", "DeRozan", "Williams", "Vucevic", "Caruso"],
    context: "Caruso picked up Lillard full court. Vucevic is in drop. Giannis trails on the break. Bulls have no fouls to give.",
    question: "Push or set?",
    options: [
      { label: "Drag screen Giannis → Lillard pull-up 3", sub: "Vucevic forced up", ev: 1.20, isOptimal: true },
      { label: "Iso Lillard step-back over Caruso", sub: "Caruso top-tier on-ball", ev: 1.02, isOptimal: false },
      { label: "Lob Giannis at the rim", sub: "Tie + foul shot", ev: 0.96, isOptimal: false },
      { label: "Use TO, advance to half", sub: "Set ATO", ev: 1.10, isOptimal: false },
    ],
    coachingNote:
      "Lillard's logo pull-up 3 off a high drag is ~40% this season — EV 1.20. Caruso's on-ball steal rate (3.1% per possession) makes iso the worst read here. Lobbing Giannis only ties; you still defend a final shot with the Bulls having no TO. The drag forces Vucevic out of drop, which is where Lillard's hot zone is.",
    references: [{ kind: "player", name: "Damian Lillard" }],
  },
  {
    id: "late-defense-5",
    category: "late-defense",
    difficulty: 2,
    title: "Up 2, 11 seconds, defense, no fouls to give",
    situation: [
      "Q4 · 0:11 left · Up 2",
      "They inbound from mid-court · 1 TO each · In bonus",
    ],
    myTeam: ["Fox (you)", "Vassell", "Sochan", "Barnes K.", "Wembanyama"],
    theirTeam: ["Luka", "Kyrie", "Klay", "PJ", "Lively"],
    context: "Luka likely step-back 3. Wemby has the only shot block at the rim. Kyrie's drive game vs Fox is the secondary read.",
    question: "Defensive call?",
    options: [
      { label: "Switch 1-4, Wemby drop deep", sub: "No 3s, force 2", ev: 0.92, isOptimal: true },
      { label: "Trap Luka at half court", sub: "Force ball out of hands", ev: 1.18, isOptimal: false },
      { label: "Single Luka, full help", sub: "Pack paint", ev: 1.22, isOptimal: false },
      { label: "Foul before shot", sub: "In bonus — bad math", ev: 1.62, isOptimal: false },
    ],
    coachingNote:
      "Up 2 with 11s, you live with a contested 2 and lose with any clean 3. Switching everything except Wemby keeps a shot-blocker at the rim while denying Luka a step-back. Trapping concedes the catch to Kyrie (career 39% catch-and-shoot 3) — you doubled the wrong scorer. Fouling in the bonus gives 2 FTs for a tie. The single-cover-with-help look gives Luka a clean kickout to Klay.",
    references: [{ kind: "player", name: "Victor Wembanyama" }],
  },
  {
    id: "late-defense-6",
    category: "late-defense",
    difficulty: 3,
    title: "Tied, 19 seconds, defense after timeout",
    situation: [
      "Q4 · 0:19 left · Tied",
      "They're inbounding sideline after their TO · 0 TO each for them",
    ],
    myTeam: ["LaVine (you)", "DeRozan", "Williams", "Vucevic", "Caruso"],
    theirTeam: ["Maxey", "Harden", "Oubre", "Tucker", "Embiid"],
    context: "Philly will run Spain pick-and-roll for Maxey. Embiid is the back-screener, then rolls. Tucker is the spacer.",
    question: "How do you defend the action?",
    options: [
      { label: "Switch Spain action, Caruso tags Embiid roll", sub: "Force Tucker corner 3 instead", ev: 0.96, isOptimal: true },
      { label: "Hedge Maxey hard, recover late", sub: "Give up roll dunk", ev: 1.22, isOptimal: false },
      { label: "Drop Vucevic on Embiid", sub: "Maxey gets pull-up", ev: 1.18, isOptimal: false },
      { label: "Pre-switch Caruso onto Maxey", sub: "Tip 2K's AI hand", ev: 1.10, isOptimal: false },
    ],
    coachingNote:
      "Spain P&R wins by creating two layers of action — the back screen frees the roller. Switching both screens and tagging Embiid's roll with Caruso forces the ball to Tucker (career 35% corner 3) instead of Maxey downhill or Embiid at the rim. Pre-switching telegraphs that you read the play — 2K's AI engine actually adjusts and runs a counter-action. Stay disciplined, don't show your hand.",
    references: [{ kind: "badge", name: "Switch Anchor" }],
  },
  {
    id: "pnr-4",
    category: "pnr",
    difficulty: 2,
    title: "Hedge coverage, late clock",
    situation: [
      "Q4 · 5:40 left · Tied",
      "Top P&R · Shot clock 8",
    ],
    myTeam: ["LaVine (you)", "DeRozan", "Williams", "Vucevic", "Caruso"],
    theirTeam: ["Fox", "Vassell", "Sochan", "Barnes K.", "Wembanyama"],
    context: "Wemby hedges hard 6 feet above the screen. Fox is the trailing recovery. Tagger (Vassell) is on DeRozan in the strong corner.",
    question: "LaVine's read on the hedge?",
    options: [
      { label: "Snake dribble back, attack closeout", sub: "Wemby recovers slow", ev: 1.18, isOptimal: true },
      { label: "Skip pass to weak corner Williams", sub: "Vassell stays home", ev: 1.04, isOptimal: false },
      { label: "Pull-up 3 over the hedge", sub: "Contested launch", ev: 0.88, isOptimal: false },
      { label: "Pocket pass Vucevic short roll", sub: "Wemby behind play", ev: 1.12, isOptimal: false },
    ],
    coachingNote:
      "Snake dribble (back across the screen) makes the hedger run twice — Wemby's recovery time post-hedge is 1.4s, which is enough for LaVine to attack the closeout. Vucevic short roll is the secondary read (1.12 EV) but Wemby's 7'4\" wingspan disrupts the pocket pass lane. Don't shoot over the hedge — contested 3s with the big in your face are sub-30%.",
    references: [{ kind: "player", name: "Zach LaVine" }],
  },
  {
    id: "pnr-5",
    category: "pnr",
    difficulty: 3,
    title: "Blitz coverage on shot creator",
    situation: [
      "Q3 · 2:15 left · Up 3",
      "Side P&R, right wing · Shot clock 12",
    ],
    myTeam: ["Maxey (you)", "Harden", "Oubre", "Tucker", "Embiid"],
    theirTeam: ["Lillard", "Beasley", "Middleton", "Giannis", "Lopez"],
    context: "Bucks blitz Maxey with two defenders. Giannis is the second man up. Embiid's man (Lopez) tags the short roll. Harden is in the slot.",
    question: "Maxey's read on the blitz?",
    options: [
      { label: "Pass over top to Embiid short roll", sub: "4-on-3 advantage", ev: 1.24, isOptimal: true },
      { label: "Split the trap with a hesi", sub: "Risk turnover", ev: 0.86, isOptimal: false },
      { label: "Throw it back to Harden, reset", sub: "Burn 6 seconds", ev: 1.06, isOptimal: false },
      { label: "Force pull-up 3 over Giannis", sub: "Beat the trap with the shot", ev: 0.72, isOptimal: false },
    ],
    coachingNote:
      "Blitz = 4-on-3 if you make the right pass. Embiid catches at the elbow with Lopez tagging — that's a 1-on-3 read for Embiid: shoot the elbow J (1.10 EV), drive at Lopez (1.20 EV), or kick to a wide-open Oubre/Tucker (1.30 EV). The pass over the top is the highest-leverage decision a guard makes against a blitz. Splitting two NBA defenders is sub-10% completion — don't be the kid trying it in ranked.",
    references: [{ kind: "player", name: "Joel Embiid" }],
  },
  {
    id: "iso-4",
    category: "iso",
    difficulty: 2,
    title: "Post mismatch vs switching defense",
    situation: [
      "Q4 · 4:30 left · Down 3",
      "Right block iso · Shot clock 15",
    ],
    myTeam: ["DeRozan (you)", "LaVine", "Williams", "Vucevic", "Caruso"],
    theirTeam: ["Curry", "Podziemski", "Wiggins", "Kuminga", "Looney"],
    context: "DeRozan post-up on Curry after a switch. Help is one pass away (Podziemski on LaVine in the slot).",
    question: "Move?",
    options: [
      { label: "Turnaround mid jumper", sub: "DeRozan signature shot", ev: 1.20, isOptimal: true },
      { label: "Back down hard for layup", sub: "Force help rotation", ev: 1.04, isOptimal: false },
      { label: "Kick to LaVine, re-post", sub: "Reset action", ev: 0.96, isOptimal: false },
      { label: "Face up, drive baseline", sub: "Beat Curry on first step", ev: 1.08, isOptimal: false },
    ],
    coachingNote:
      "DeRozan's turnaround mid-post J vs a guard is the highest-volume shot in his profile — career 51% on it. EV 1.20 with the Curry mismatch. Backing him down chains a help rotation from Looney; you trade a 1.20 shot for ~0.95 contested layup. Resetting wastes clock and lets them re-switch. Face-up drives against Curry are fine but slower to develop than the catch-and-shoot turnaround.",
    references: [{ kind: "player", name: "DeMar DeRozan" }],
  },
  {
    id: "iso-5",
    category: "iso",
    difficulty: 3,
    title: "Speed iso, late clock, sticky on-ball",
    situation: [
      "Q4 · 1:20 left · Up 1",
      "Top of key iso · Shot clock 7",
    ],
    myTeam: ["Fox (you)", "Vassell", "Sochan", "Barnes K.", "Wembanyama"],
    theirTeam: ["Mitchell", "Garland", "Strus", "Mobley", "Allen"],
    context: "Mitchell on Fox, tight. Allen sagging in drop. Fox has a half-step quickness edge but Mitchell's lateral D is elite.",
    question: "Fox's move?",
    options: [
      { label: "Hesi-pull mid floater range", sub: "Beat Allen drop", ev: 1.16, isOptimal: true },
      { label: "Straight-line drive at Allen", sub: "Speed advantage", ev: 1.04, isOptimal: false },
      { label: "Step-back 3 over Mitchell", sub: "Sticky contest", ev: 0.94, isOptimal: false },
      { label: "Kick to Wemby high post", sub: "Re-screen action", ev: 1.00, isOptimal: false },
    ],
    coachingNote:
      "Fox's floater range (12-15 ft) is his statistical sweet spot — 54% conversion vs drop coverage. Hesi-pull at 7 on the clock keeps the shot clean. Driving at Allen is fine but Mitchell recovers on the dribble; you end up at the rim with two contests. Step-back 3 vs Mitchell is contested — Mitchell's perimeter D rating leads guards. Don't kick at 7 unless your re-screen is pre-loaded.",
    references: [{ kind: "player", name: "De'Aaron Fox" }],
  },
  {
    id: "oot-4",
    category: "oot",
    difficulty: 2,
    title: "OOT — sideline OB after made FT, up 1",
    situation: [
      "Q4 · 0:08 left · Up 1",
      "Sideline OB at frontcourt · 0 TO",
    ],
    myTeam: ["Butler (you)", "Herro", "Rozier", "Adebayo", "Ware"],
    theirTeam: ["Tatum", "Holiday", "White", "Brown", "Horford"],
    context: "Boston is denying the ball-side entry. Tatum jumped the passing lane on the last possession. Brown will help-and-recover.",
    question: "Best inbound action?",
    options: [
      { label: "Stack screen for Butler curl, drive", sub: "Force foul or layup", ev: 1.12, isOptimal: true },
      { label: "Inbound to Adebayo, post Horford", sub: "DHO into mid J", ev: 1.04, isOptimal: false },
      { label: "Skip to Herro corner 3", sub: "White's man", ev: 1.18, isOptimal: false },
      { label: "Quick inbound to Rozier, iso", sub: "Beat Holiday off catch", ev: 0.90, isOptimal: false },
    ],
    coachingNote:
      "Stack screens beat denial pressure because the off-ball action confuses the lane-jumper read. Butler curling off two screens at 6'8\" forces Tatum to chase over the top — and Butler's catch-and-go to the rim is ~58% conversion plus 22% foul rate. The Herro corner 3 (1.18 EV theoretical) is tempting but skip passes get jumped by Boston's defense at a 14% rate this season. Take the higher-floor read with 8s and a 1-point lead.",
    references: [{ kind: "player", name: "Bam Adebayo" }],
  },
  {
    id: "oot-5",
    category: "oot",
    difficulty: 3,
    title: "OOT — baseline OB, down 1",
    situation: [
      "Q4 · 0:04 left · Down 1",
      "Baseline OB under own basket · 1 TO",
    ],
    myTeam: ["LaVine (you)", "DeRozan", "Williams", "Vucevic", "Caruso"],
    theirTeam: ["SGA", "Dort", "J. Williams", "Holmgren", "Hartenstein"],
    context: "Holmgren is the back-line shot blocker. Dort is on LaVine and will fight through screens. SGA is sagging off Caruso.",
    question: "Best ATO?",
    options: [
      { label: "Iverson cut LaVine → curl mid jumper", sub: "Holmgren can't help", ev: 1.16, isOptimal: true },
      { label: "Lob to Vucevic at rim", sub: "Beat Holmgren contest", ev: 0.72, isOptimal: false },
      { label: "DeRozan post-up Dort cross-match", sub: "Mismatch post entry", ev: 1.06, isOptimal: false },
      { label: "Quick 3 from Williams corner", sub: "SGA cheating off Caruso", ev: 1.04, isOptimal: false },
    ],
    coachingNote:
      "Iverson cut (LaVine over two staggered screens at the elbow) curls into the mid-post — that's a 1.16 EV pull-up J vs Dort recovering. Holmgren is stuck rim-protecting; he can't tag the curl without leaving Vucevic. The lob is the worst look — Holmgren's vertical contest rating at 7'1\" with a 7'6\" wingspan grades S-tier. DeRozan post is fine (1.06) but you only have 4s, which is barely enough for a post catch and turnaround.",
    references: [{ kind: "player", name: "Zach LaVine" }],
  },
  {
    id: "ft-game-4",
    category: "ft-game",
    difficulty: 2,
    title: "Down 6, 1:08 left, fouling cascade",
    situation: [
      "Q4 · 1:08 left · Down 6",
      "They have ball after made bucket · 2 TO each",
    ],
    myTeam: ["Lillard (you)", "Beasley", "Middleton", "Giannis", "Lopez"],
    theirTeam: ["Butler", "Herro", "Rozier", "Adebayo", "Ware"],
    context: "Butler shoots 86% FT. Herro 89%. Rozier 81%. Adebayo 76%. Ware (rookie C) 62%.",
    question: "Foul target?",
    options: [
      { label: "Foul Ware on the catch", sub: "62% — worst on floor", ev: 1.24, isOptimal: true },
      { label: "Foul Adebayo, force missed 2nd", sub: "76% — passable", ev: 1.52, isOptimal: false },
      { label: "Foul any non-Butler immediately", sub: "Generic — burns clock", ev: 1.66, isOptimal: false },
      { label: "Don't foul, force a turnover", sub: "Heat in bonus", ev: 1.40, isOptimal: false },
    ],
    coachingNote:
      "Down 6 with 68s means 3 made possessions needed — every percentage point of opponent FT% costs you a possession's chance. Ware at 62% means each foul = 1.24 expected points; that's a ~38% chance you get a missed second FT, which is a possession swing. Generic fouling at 80%+ FT% concedes the game in 2 trips. Force Ware (or their lowest FT shooter) into the action with a foul on the inbounder if needed.",
    references: [{ kind: "badge", name: "Free Throw Ace" }],
  },
  {
    id: "pnr-6",
    category: "pnr",
    difficulty: 2,
    title: "Switch into post mismatch",
    situation: [
      "Q3 · 4:10 left · Down 2",
      "Top P&R · Shot clock 17",
    ],
    myTeam: ["Butler (you)", "Herro", "Rozier", "Adebayo", "Ware"],
    theirTeam: ["LaMelo", "Brandon Miller", "Williams", "Bridges", "Plumlee"],
    context: "Charlotte switches the P&R. LaMelo (6'7\", 180) ends up on Bam Adebayo (6'9\", 255).",
    question: "How do you use the switch?",
    options: [
      { label: "Throw to Bam, immediate post entry on LaMelo", sub: "Backdown for layup or kick", ev: 1.22, isOptimal: true },
      { label: "Continue P&R action with Butler", sub: "Re-screen Plumlee", ev: 1.08, isOptimal: false },
      { label: "Butler iso vs Plumlee", sub: "Speed mismatch top", ev: 1.10, isOptimal: false },
      { label: "Pull-up 3 over Plumlee in drop", sub: "Quick launch", ev: 0.96, isOptimal: false },
    ],
    coachingNote:
      "Switch hunting only matters if you exploit it within 4 seconds — the defense will pre-switch on the next action. Bam posting LaMelo is a 75-pound strength gap; backdown EV sits at 1.22 (50% chance bucket, 22% chance foul drawn). Butler vs Plumlee is fine but slower to develop, giving Charlotte time to dig down. Don't waste the switch on a pull-up.",
    references: [{ kind: "player", name: "Bam Adebayo" }],
  },
  {
    id: "ft-game-5",
    category: "ft-game",
    difficulty: 1,
    title: "Up 3, 12 seconds, foul or defend",
    situation: [
      "Q4 · 0:12 left · Up 3",
      "They have ball at logo · 1 TO each",
    ],
    myTeam: ["Mitchell (you)", "Garland", "Strus", "Mobley", "Allen"],
    theirTeam: ["Halliburton", "Nembhard", "Mathurin", "Siakam", "Turner"],
    context: "Halliburton shoots 87% FT. Turner shoots 80%. Mathurin shoots 84%. No one on Indy is below 78%.",
    question: "Foul or play it straight?",
    options: [
      { label: "Don't foul, contest hard, no 3s", sub: "Everyone's a good FT shooter", ev: 0.78, isOptimal: true },
      { label: "Foul Turner immediately", sub: "Lowest FT% on floor — still 80%", ev: 1.60, isOptimal: false },
      { label: "Foul Halliburton on catch", sub: "87% — terrible math", ev: 1.74, isOptimal: false },
      { label: "Switch everything, dare the 2", sub: "Concede mid range", ev: 0.84, isOptimal: false },
    ],
    coachingNote:
      "Foul-up-3 math only works when the FT shooter is sub-72%. Turner at 80% means each foul produces 1.60 expected points, and you also concede possession + clock. With everyone on Indy 78%+, defending the contested 3 (which they hit at ~36% in this look = 1.08 EV) is the lower expected cost. Run them off the line, give up the 2, win in regulation.",
    references: [{ kind: "player", name: "Donovan Mitchell" }],
  },
];
