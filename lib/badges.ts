...
export const BADGES: Badge[] = [
  ...
  // ───────────── NEW BADGES (8) ─────────────
  b("Tunnel Vision", "Defense", "A",
    "Reduces opponent passing accuracy when guarded by", 14,
    "Perimeter Defense 80+ · Defensive Awareness 75+",
    "~7 hrs MyCareer",
    [
      { patch: "1.7", delta: +3, note: "Now affects skip-pass arcs too" },
      { patch: "1.6", delta: 0, note: "Introduced as B-tier baseline" },
    ],
    ["interceptor", "on-ball-menace"]),
  b("Post Lockdown", "Defense", "B",
    "Reduces post move success against you by", 13,
    "Interior Defense 78+ · Strength 75+",
    "~6 hrs MyCareer",
    [
      { patch: "1.7", delta: +2, note: "Drop-step and up-and-under counters added" },
      { patch: "1.6", delta: +3, note: "Initial buff in 1.6" },
    ],
    ["brick-wall-defense", "anchor"]),
  b("Strip Specialist", "Defense", "B",
    "Boosts strip chance on layup gather frames by", 16,
    "Steal 78+ · Interior Defense 70+",
    "~6 hrs MyCareer",
    [
      { patch: "1.7", delta: +4, note: "Gather-frame window widened by 2 frames" },
    ],
    ["pickpocket", "rim-protector"]),
  b("Closeout Specialist", "Defense", "C",
    "Reduces blow-by chance on sprint closeouts by", 10,
    "Perimeter Defense 76+ · Speed 75+",
    "~5 hrs MyCareer",
    [
      { patch: "1.7", delta: +2, note: "Lateral recovery improved post-closeout" },
    ],
    ["lane-lockdown", "challenger"]),
  b("Glass Eater", "Rebounding", "A",
    "Boosts contested rebound win rate by", 17,
    "Defensive Rebound 80+ · Strength 75+",
    "~6 hrs MyCareer",
    [
      { patch: "1.7", delta: +3, note: "Two-handed rip-down animations more frequent" },
      { patch: "1.6", delta: 0, note: "No change" },
    ],
    ["box", "rebound-chaser"]),
  b("Tip Master", "Rebounding", "B",
    "Boosts tip-in success on missed shots by", 13,
    "Vertical 78+ · Offensive Rebound 75+",
    "~5 hrs MyCareer",
    [
      { patch: "1.7", delta: +3, note: "Window extended on close-range tips" },
    ],
    ["second-jump", "putback-boss"]),
  b("Help Side Rebounder", "Rebounding", "C",
    "Boosts rebound chance when starting outside the paint by", 9,
    "Defensive Rebound 75+ · Speed 75+",
    "~4 hrs MyCareer",
    [
      { patch: "1.7", delta: +2, note: "Weak-side board pathing improved" },
    ],
    ["long-range-board"]),
  b("Free Throw Fiend", "Shooting", "B",
    "Boosts FT% on consecutive attempts by", 11,
    "FT 75+",
    "~4 hrs MyCareer",
    [
      { patch: "1.7", delta: +2, note: "Stack now persists across quarters" },
      { patch: "1.6", delta: 0, note: "No change" },
    ],
    ["free-throw-ace"]),
];
